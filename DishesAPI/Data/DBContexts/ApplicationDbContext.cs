...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        _ = modelBuilder.Entity<Dish>().HasData(
           new(Guid.Parse("eacc9615-b2a7-41ad-92c3-dbb1a5e7af06"),
        ...
        _ = modelBuilder
            ...
            .UsingEntity(e => e.HasData(
                new { DishesId = Guid.Parse("eacc9615-b2a7-41ad-92c3-dbb1a5e7af06"), IngredientsId = Guid.Parse("d28888e9-2ba9-473a-a40f-e38cb54f9b35") },
                new { DishesId = Guid.Parse("eacc9615-b2a7-41ad-92c3-dbb1a5e7af06"), IngredientsId = Guid.Parse("da2fd609-d754-4feb-8acd-c4f9ff13ba96") },
                new { DishesId = Guid.Parse("eacc9615-b2a7-41ad-92c3-dbb1a5e7af06"), IngredientsId = Guid.Parse("c19099ed-94db-44ba-885b-0ad7205d5e40") },
                new { DishesId = Guid.Parse("eacc9615-b2a7-41ad-92c3-dbb1a5e7af06"), IngredientsId = Guid.Parse("0c4dc798-b38b-4a1c-905c-a9e76dbef17b") },
                new { DishesId = Guid.Parse("eacc9615-b2a7-41ad-92c3-dbb1a5e7af06"), IngredientsId = Guid.Parse("937b1ba1-7969-4324-9ab5-afb0e4d875e6") },
                new { DishesId = Guid.Parse("eacc9615-b2a7-41ad-92c3-dbb1a5e7af06"), IngredientsId = Guid.Parse("7a2fbc72-bb33-49de-bd23-c78fceb367fc") },
                new { DishesId = Guid.Parse("eacc9615-b2a7-41ad-92c3-dbb1a5e7af06"), IngredientsId = Guid.Parse("b5f336e2-c226-4389-aac3-2499325a3de9") },
                new { DishesId = Guid.Parse("eacc9615-b2a7-41ad-92c3-dbb1a5e7af06"), IngredientsId = Guid.Parse("c22bec27-a880-4f2a-b380-12dcd99c61fe") },
                new { DishesId = Guid.Parse("eacc9615-b2a7-41ad-92c3-dbb1a5e7af06"), IngredientsId = Guid.Parse("d5cad9a4-144e-4a3d-858d-9840792fa65d") },
